...
```{r}
test_regression <-
  lm(ppp_allvars_1018$days_to_approval ~ 1 + ppp_allvars_1018$estimate_median_income_dollars_families_families +
       ppp_allvars_1018$percent_estimate_race_total_population_one_race_black_or_african_american +
       ppp_allvars_1018$percent_estimate_race_total_population_one_race_white + ppp_allvars_1018$high_school_pct +
       ...
       ppp_allvars_1018$pct + ppp_allvars_1018$mean_start_cases_weighted + 
