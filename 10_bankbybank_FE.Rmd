...
county_rt1_biz <- felm(business_days ~ 1 + 
    ...
    mean_start_deaths + 
    mean_end_cases +
    mean_end_deaths + national + cu + 
    business_roundtable + 
    I(business_roundtable * percent_minority_biz)|lender + state|0|fips, 
...
county_rt2_biz <- felm(business_days ~ 1 + 
    ...
    I(national * percent_minority_biz)|lender + state|0|fips, 
    data = most_recent_ownership_county
)
```
...
baml_biz <- felm(business_days ~ 1 + 
    ...
    mean_end_cases +
    mean_end_deaths + national + cu + 
    baml + I(baml * percent_minority_biz)|lender + state|0|fips, 
    data = most_recent_ownership_county
)
...
citi_biz <- felm(business_days ~ 1 + 
    ...
    mean_end_cases +
    mean_end_deaths + national + cu + 
    citi + I(citi * percent_minority_biz)|lender + state|0|fips, 
    data = most_recent_ownership_county
)
...
jpm_biz <- felm(business_days ~ 1 + 
    ...
    mean_end_cases +
    mean_end_deaths + national + cu + 
    jpm + I(jpm * percent_minority_biz)|lender + state|0|fips, 
    data = most_recent_ownership_county
)
```
...
wells_biz <- felm(business_days ~ 1 + 
    ...
    mean_end_cases +
    mean_end_deaths + national + cu + 
    wells + I(wells * percent_minority_biz)|lender + state|0|fips, 
    data = most_recent_ownership_county
)
```
...
national_biz <- felm(business_days ~ 1 + 
    ...
    mean_end_cases +
    mean_end_deaths +
    national + I(national * percent_minority_biz)|lender + state|0|fips, 
    data = most_recent_ownership_county
)
...
cu_biz <- felm(business_days ~ 1 + 
    ...
    mean_start_deaths + 
    mean_end_cases +
    mean_end_deaths + cu + I(cu * percent_minority_biz)|lender + state|0|fips, 
    data = most_recent_ownership_county
)
```
