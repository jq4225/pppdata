...
baml_reg_only <- felm(
    ...
    non_essential_closure_current + 
       baml + I(baml * minority_percent)|fips|0|zip + fips, 
    data = most_recent)
...
jpm_reg_only <- felm(
    ...
    non_essential_closure_apr + 
    non_essential_closure_current + 
       jpm + I(jpm * minority_percent)|fips|0|zip + fips, 
    data = most_recent)
...
citi_reg_only <- felm(
    ...
    non_essential_closure_apr + 
    non_essential_closure_current + 
       citi + I(citi * minority_percent)|fips|0|zip + fips, 
    data = most_recent)
...
wells_reg_only <- felm(
    ...
    non_essential_closure_apr + 
    non_essential_closure_current + 
       wells + I(wells * minority_percent)|fips|0|zip + fips, 
    data = most_recent)
...
cu_reg_only <- felm(
    ...
    non_essential_closure_apr + 
    non_essential_closure_current + 
       cu + I(cu * minority_percent)|fips|0|zip + fips, 
    data = most_recent)
...
national_reg_only <- felm(
    ...
    non_essential_closure_apr + 
    non_essential_closure_current + 
       national + I(national * minority_percent)|fips|0|zip + fips, 
    data = most_recent)
```
...
# Robustness check - running these regressions on the ZIP + county combined dataset
...
baml_check <- felm(
  business_days ~ 1 + 
    ...
    non_essential_closure_apr + 
    non_essential_closure_current + 
       national + baml + I(baml*minority_percent)|fips|0|zip + fips, 
    data = most_recent)
...
roundtable_reg1 <- felm(
    ...
    non_essential_closure_current + 
      ...
      I(business_roundtable * minority_percent) + 
       ...
       I(business_roundtable * unemployment_rate)|fips|0|zip + fips, 
    data = most_recent)
...
citi_check <- felm(
  business_days ~ 1 + 
    ...
    non_essential_closure_apr +
    non_essential_closure_current + 
       baml + I(baml * minority_percent)|0|0|zip + fips, 
    data = most_recent_both)
...
# Trying bank-specific!

# Read the file in if you have to

most_recent_deposits <- readRDS('most_recent_zip_banksmatched_1124.rds') %>%
  mutate(national = 0) %>%
  mutate(national = ifelse(str_detect(lender, pattern = "national association"),
                           1, national),
         national = ifelse(str_detect(lender, pattern = "n.a."),
