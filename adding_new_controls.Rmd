...
library(janitor)
library(readxl)
ppp_allstates <- readRDS(file = "zip_ppp_allstates_1017_dummy.rds")
#ppp_allstates_pvi <- readRDS(file = "ppp_pvi_1017.rds")
...
# Didn't end up doing this -- just using covid cases in the beginning of April -- this is wayyy too computationally intensive
