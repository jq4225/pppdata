...
demographics_check <- felm(business_days ~ 1 + 
    ...
    rural +
    estimate_gini_index +
    county_crime_rate|fips|0|zip, data = most_recent_both)
...
loan_spec_check <- felm(
  business_days ~ 1 + 
    ...
    cu +
    bank_ppp_issued + 
    jobs_reported|fips|0|zip, data = most_recent_both)
...
econ_check <- felm(
  business_days ~ 1 + 
    ...
    county_unemployment_rate|fips|0|zip, data = most_recent_both)
...
interactions_check <- felm(
  business_days ~ 1 + 
    ...
    I(minority_percent * rural) + 
    I(minority_percent * estimate_gini_index) +
    I(minority_percent * county_crime_rate)|fips|0|zip,
  data = most_recent_both)
```
