...
# Doing the same on zip level -- don't run this, it doesn't work lol

covid_fe <- felm(
  business_days ~ 1 + 
    median_family_income + 
    percent_minority_biz_county +
    high_school_pct + 
    married_percent + male_percent + 
    cook_pvi + 
    rural +
    ...
    stay_at_home_current + 
    non_essential_closure_apr + 
    non_essential_closure_current|state + lender|0|fips,
