...
gender <- 
  read_csv('raw_data/county/ACSDP5Y2018.DP05_data_with_overlays_2020-11-12T203338.csv', skip = 1) %>%
  clean_names() %>%
  select(id,
...
most_recent_county_2 <- left_join(most_recent_county, gender, by = "fips") %>%
